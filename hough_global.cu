 ...
 * Curso: Computación Paralela y Distrbuida - CC3069
 * 
 * Archivo: hough_global.cu
 * 
 * Autores:
 * - Pedro Arriola (20188)
 * - Oscar Lopez (20679)
 ...
 * Hough en CUDA para la detección de líneas rectas en imágenes. El código
 * hace uso estratégico de la memoria global en la arquitectura CUDA
